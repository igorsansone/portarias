  ...
  return (
    <div className="card">
      <div className="filters">
        ...
        <select
          value={filter.assinada}
          onChange={(e) => setFilter({ ...filter, assinada: e.target.value })}
        >
        ...
        <select
          value={filter.publicada}
          onChange={(e) => setFilter({ ...filter, publicada: e.target.value })}
        >
        ...
        <select
          value={filter.tem_pdf}
          onChange={(e) => setFilter({ ...filter, tem_pdf: e.target.value })}
        >
